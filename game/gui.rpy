...
define gui.text_font = "Bitter-Medium.ttf"

## El tipo de letra de los nombres de personajes
define gui.name_text_font = "Bitter-Bold.ttf"

## El tipo de letra del texto externo al juego.
define gui.interface_text_font = "Bitter-Black.ttf"
